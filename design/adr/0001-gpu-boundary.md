...
This ADR solidifies "GPU boundaries" into architectural decision records and incorporates them into `design/adr/` for continuous tracking. This issue stems from the `design/DESIGN.md` §13 open issue and is still open.
