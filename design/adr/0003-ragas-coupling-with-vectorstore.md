...
This ADR solidifies the "coupling of Ragas and VectorStore" into an architectural decision record and incorporates it into `design/adr/` for continuous tracking. This issue stems from the `design/DESIGN.md` §13 open issue and is still open.
