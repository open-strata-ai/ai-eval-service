...
This ADR solidifies "report storage and long-term trends" into architectural decision records and incorporates them into `docs/adr/` for continuous tracking. This issue stems from the `docs/DESIGN.md` §13 open issue and is still open.
