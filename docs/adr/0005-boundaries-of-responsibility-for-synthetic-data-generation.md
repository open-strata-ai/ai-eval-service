...
This ADR solidifies the "responsibility boundaries of synthetic data generation" into architectural decision records and incorporates them into `docs/adr/` for continuous tracking. This issue stems from the `docs/DESIGN.md` §13 open issue and is still open.
